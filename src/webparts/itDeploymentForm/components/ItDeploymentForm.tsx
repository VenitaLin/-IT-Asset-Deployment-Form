...
export default class ItDeploymentForm extends React.Component<
  IItDeploymentFormProps,
  IItDeploymentFormState
> {
  ...
  private issReSigPad: any;
  private issIssSigPad: any;
  private returnReSigPad: any;
  private returnAckSigPad: any;
      ...
      <div className={styles.itDeploymentForm}>
        <div className={styles.container}>
          <div className={styles.title}>
            <img src={require("../../../img/sbfLogo.png")}></img>
            <br></br>
              ...
              <tbody>
                  ...
                  <td colSpan={3}>
                    <u>
                      <input
                        ...
                        className={styles.otherAccessories}
                        placeholder="Others"
                        onChange={this.handleChange}
                      ></input>
                    </u>
                ...
                <tr>
                  <td colSpan={4}>
                    ...
                    <ol type="a">
                      <li>
                        I am responsible for the equipment(s) issued to me and
                        that I will care for the equipment(s) in such a manner
                        as to prevent loss or damage.
                      </li>
                      <li>
                        All programs or applications are to be approved and
                        installed by the DTS Department.
                      </li>
                      <li>
                        I will perform regular housekeeping to ensure that the
                        Notebook is functioning at its optimal at all times.{" "}
                      </li>
                      <li>
                        To extend the lifespan of the Notebook effectively and
                        at its optimal performance, daily{" "}
                        <b>
                          <u>SHUTDOWN</u>
                        </b>{" "}
                        is{" "}
                      ...
                      <li>
                        For the loss of Notebook, I will bear the pro-rated cost
                        based on net book value (3-years)
                      </li>
                      <li>
                        For the loss of other IT equipment(s), I will either
                        bear the full cost or replace with a similar one.
                      </li>
                    </ol>
                  </td>
                </tr>
    ...
    this.setState(
      {
        ...
        returnReSig: this.returnReSigPad
          .getTrimmedCanvas()
          .toDataURL("image/png"),
        returnAckSig: this.returnAckSigPad
          .getTrimmedCanvas()
          .toDataURL("image/png"),
      },
      function () {
  ...
  private handleCheckboxChange = (e) => {
    ...
    currAccs.forEach((Acc: { value: any; isChecked: any }) => {
      if (Acc.value === selectedAcc) Acc.isChecked = e.target.checked;
    });
    this.setState({
